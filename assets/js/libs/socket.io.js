...
(function(n, t) {
    ...
    i.j = [],
    i.sockets = {},
    i.connect = function(n, r) {
        var u = i.util.parseUri(n),
        o,
        f,
        e;
        return t && t.location && (u.protocol = u.protocol || t.location.protocol.slice(0, -1), u.host = u.host || (t.document ? t.document.domain: t.location.hostname), u.port = u.port || t.location.port),
        o = i.util.uniqueUri(u),
        e = {
            host: u.host,
        ...
        i.util.merge(e, r),
        (e["force new connection"] || !i.sockets[o]) && (f = new i.Socket(e)),
        !e["force new connection"] && f && (i.sockets[o] = f),
        f = f || i.sockets[o],
        f.of(u.path.length > 1 ? u.path: "")
    }
...
(function(n, t) {
    ...
    i.uniqueUri = function(n) {
        ...
        i = n.host,
        r = n.port;
        return "document" in t ? (i = i || document.domain, r = r || (u == "https" && document.location.protocol !== "https:" ? 443 : document.location.port)) : (i = i || "localhost", r || u != "https" || (r = 443)),
        (u || "http") + "://" + i + ":" + (r || 80)
    },
    ...
    i.chunkQuery = function(n) {
        for (var u = {},
        r = n.split("&"), i = 0, f = r.length, t; i < f; ++i) t = r[i].split("="),
        t[0] && (u[t[0]] = t[1]);
        return u
    },
    r = !1,
    ...
    i.indexOf = function(n, t, i) {
        for (var r = n.length,
        i = i < 0 ? i + r < 0 ? 0 : i + r: i || 0; i < r && n[i] !== t; i++);
        return r <= i ? -1 : i
    },
    ...
    i.ua = {},
    i.ua.hasCORS = "undefined" != typeof XMLHttpRequest &&
    function() {
        try {
...
(function(n, t) {
    ...
    i.prototype.on = function(n, i) {
        ...
        this.$events[n] ? t.util.isArray(this.$events[n]) ? this.$events[n].push(i) : this.$events[n] = [this.$events[n], i] : this.$events[n] = i,
        this
    },
    i.prototype.addListener = i.prototype.on,
    i.prototype.once = function(n, t) {
        function i() {
            r.removeListener(n, i),
    ...
    i.prototype.emit = function(n) {
        ...
        else if (t.util.isArray(i)) for (u = i.slice(), r = 0, e = u.length; r < e; r++) u[r].apply(this, f);
        else return ! 1;
        return ! 0
    }
...
(function(n, t) {
    ...
    function e(n, t) {
        var h, l, c, v, y = i,
        o, u = t[n];
        u instanceof Date && (u = a(n)),
        typeof r == "function" && (u = r.call(t, n, u));
        switch (typeof u) {
        case "string":
            return s(u);
        case "number":
        ...
        case "object":
            ...
            if (r && typeof r == "object") for (v = r.length, h = 0; h < v; h += 1) typeof r[h] == "string" && (l = r[h], c = e(l, u), c && o.push(s(l) + (i ? ": ": ":") + c));
            else for (l in u) Object.prototype.hasOwnProperty.call(u, l) && (c = e(l, u), c && o.push(s(l) + (i ? ": ": ":") + c));
            return c = o.length === 0 ? "{}": i ? "{\n" + i + o.join(",\n" + i) + "\n" + y + "}": "{" + o.join(",") + "}",
            i = y,
            c
        }
    ...
    o.stringify = function(n, t, u) {
        ...
        i = "",
        f = "";
        if (typeof u == "number") for (o = 0; o < u; o += 1) f += " ";
...
(function(n, t) {
    ...
    i.encodePacket = function(n) {
        ...
        switch (n.type) {
        case "error":
            h = n.reason ? u(o, n.reason) : "",
            i = n.advice ? u(s, n.advice) : "",
            (h !== "" || i !== "") && (t = h + (i !== "" ? "+" + i: ""));
            break;
        case "message":
            n.data !== "" && (t = n.data);
        ...
        case "event":
            ...
            n.args && n.args.length && (f.args = n.args),
            t = r.stringify(f);
            break;
        case "json":
        ...
        return c = [l, y + (a == "data" ? "+": ""), v],
        t !== null && t !== undefined && c.push(t),
        c.join(":")
    },
...
(function(n, t, i) {
    ...
    r.prototype.getTransport = function(n) {
        for (var u = n || this.transports,
        f, i, r = 0; i = u[r]; r++) if (t.Transport[i] && t.Transport[i].check(this) && (!this.isXDomain() || t.Transport[i].xdomainCheck())) return new t.Transport[i](this, this.sessionid);
        return null
    },
    r.prototype.connect = function(n) {
        ...
        return this.handshake(function(r, u, f, e) {
            function o(n) {
                i.transport && i.transport.clearTimeouts(),
                i.transport = i.getTransport(n);
                ...
                function() {
                    ...
                    i.transport.open(),
                    i.options["connect timeout"] && (i.connectTimeoutTimer = setTimeout(function() {
                        if (!i.connected) {
                            i.connecting = !1;
            ...
            i.sessionid = r,
            i.closeTimeout = f * 1e3,
            i.heartbeatTimeout = u * 1e3,
            i.transports = t.util.intersect(e.split(","), i.options.transports),
            o();
            i.once("connect",
            function() {
    ...
    r.prototype.packet = function(n) {
        return this.connected && !this.doBuffer ? this.transport.packet(n) : this.buffer.push(n),
        this
    },
    r.prototype.setBuffer = function(n) {
        this.doBuffer = n,
        !n && this.connected && this.buffer.length && (this.transport.payload(this.buffer), this.buffer = [])
    },
    ...
    r.prototype.onError = function(n) {
        n && n.advice && this.options.reconnect && n.advice === "reconnect" && this.connected && (this.disconnect(), this.reconnect()),
        this.publish("error", n && n.reason ? n.reason: n)
    },
    r.prototype.onDisconnect = function(n) {
        ...
        this.connecting = !1,
        this.open = !1,
        t && (this.transport.close(), this.transport.clearTimeouts(), this.publish("disconnect", n), "booted" != n && this.options.reconnect && !this.reconnecting && this.reconnect())
    },
    r.prototype.reconnect = function() {
        function i() {
            ...
            n.options["try multiple transports"] = r
        }
        function t() {
            ...
            if (n.reconnectionAttempts++<u) n.reconnectionDelay < f && (n.reconnectionDelay *= 2),
            n.connect(),
            n.publish("reconnecting", n.reconnectionDelay, n.reconnectionAttempts),
            n.reconnectionTimer = setTimeout(t, n.reconnectionDelay);
            else if (n.redoTransports) n.publish("reconnect_failed"),
            i();
            else {
...
(function(n, t) {
    ...
    n.SocketNamespace = i,
    t.util.mixin(i, t.EventEmitter),
    i.prototype.$emit = t.EventEmitter.prototype.emit,
    i.prototype.of = function() {
        return this.socket.of.apply(this.socket, arguments)
    },
    i.prototype.packet = function(n) {
        return n.endpoint = this.name,
        this.socket.packet(n),
        this.flags = {},
        this
    },
    i.prototype.send = function(n, t) {
        ...
        return "function" == typeof t && (i.id = ++this.ackPackets, i.ack = !0, this.acks[i.id] = t),
        this.packet(i)
    },
    i.prototype.emit = function(n) {
        ...
        return "function" == typeof r && (i.id = ++this.ackPackets, i.ack = "data", this.acks[i.id] = r, t = t.slice(0, t.length - 1)),
        i.args = t,
        this.packet(i)
    },
    ...
    i.prototype.onPacket = function(n) {
        ...
        case "json":
            i = ["message", n.data],
            n.ack == "data" ? i.push(r) : n.ack && this.packet({
                type: "ack",
                ackId: n.id
            }),
...
(function(n, t, i) {
    ...
    r.prototype.open = function() {
        ...
        n = this,
        r;
        return r || (r = i.MozWebSocket || i.WebSocket),
        this.websocket = new r(this.prepareUrl() + u),
    ...
    r.prototype.send = function(n) {
        return this.websocket.send(n),
        this
    },
    r.prototype.payload = function(n) {
        for (var t = 0,
        i = n.length; t < i; t++) this.packet(n[t]);
        return this
    },
...
(function(n, t) {
    ...
    n.flashsocket = i,
    t.util.inherit(i, t.Transport.websocket),
    ...
    i.prototype.ready = function(n, r) {
        function u() {
            ...
            i.loaded || (typeof WEB_SOCKET_SWF_LOCATION == "undefined" && (WEB_SOCKET_SWF_LOCATION = e.join("/")), u !== 843 && WebSocket.loadFlashPolicyFile("xmlsocket://" + t.host + ":" + u), WebSocket.__initialize(), i.loaded = !0),
            r.call(f)
        }
        var f = this;
...
if ("undefined" != typeof window) var swfobject = function() {
    function v() {
        ...
        if (c) return;
        try {
            i = t.getElementsByTagName("body")[0].appendChild(s("span")),
        ...
        if (y > 0) for (r = 0; r < y; r++) {
            ...
            if (n.pv[0] > 0) {
                ...
                if (t) if (!g(h[r].swfVersion) || n.wk && n.wk < 312) if (h[r].expressInstall && tt()) {
                    e = {},
                    e.data = h[r].expressInstall,
                    e.width = t.getAttribute("width") || "0",
                    e.height = t.getAttribute("height") || "0",
                    t.getAttribute("class") && (e.styleclass = t.getAttribute("class")),
                    t.getAttribute("align") && (e.align = t.getAttribute("align"));
                    var p = {},
                ...
                s && (f.success = !0, f.ref = it(o), s(f))
            } else l(o, !0),
            s && (v = it(o), v && typeof v.SetVariable != i && (f.success = !0, f.ref = v), s(f))
        }
    }
    function it(n) {
        var e = null,
        t = u(n),
        r;
        return t && t.nodeName == "OBJECT" && (typeof t.SetVariable != i ? e = t: (r = t.getElementsByTagName(f)[0], r && (e = r))),
        e
    }
    function tt() {
    ...
    function ui(t) {
        if (n.ie && n.win && t.readyState != 4) {
            ...
            i.parentNode.replaceChild(ft(t), i),
    ...
    function rt(t, r, e) {
        ...
        if (w) {
            ...
            if (n.ie && n.win) {
                ...
                w.outerHTML = '<object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000"' + y + ">" + b + "</object>",
                k[k.length] = t.id,
                v = u(t.id)
            } else {
                c = s(f),
    ...
    function wt(r, u, o, h) {
        ...
        if (!a) return;
        l = o && typeof o == "string" ? o: "screen",
        h && (e = null, ot = null),
        e && ot == l || (c = s("style"), c.setAttribute("type", "text/css"), c.setAttribute("media", l), e = a.appendChild(c), n.ie && n.win && typeof t.styleSheets != i && t.styleSheets.length > 0 && (e = t.styleSheets[t.styleSheets.length - 1]), ot = l),
        n.ie && n.win ? e && typeof e.addRule == f && e.addRule(r, u) : e && typeof t.createTextNode != i && e.appendChild(t.createTextNode(r + " {" + u + "}"))
    }
    function l(n, t) {
        if (!bt) return;
    ...
    n = function() {
        ...
        n = null,
        c;
        if (typeof o.plugins != i && typeof o.plugins[at] == f) n = o.plugins[at].description,
        !n || typeof o.mimeTypes != i && o.mimeTypes[p] && !o.mimeTypes[p].enabledPlugin || (vt = !0, h = !1, n = n.replace(/^.*\s+(\S+\s+\S+$)/, "$1"), u[0] = parseInt(n.replace(/^(.*)\..*$/, "$1"), 10), u[1] = parseInt(n.replace(/^.*\.(.*)\s.*$/, "$1"), 10), u[2] = /[a-zA-Z]/.test(n) ? parseInt(n.replace(/^.*[a-zA-Z]+(.*)$/, "$1"), 10) : 0);
        else if (typeof r.ActiveXObject != i) try {
            c = new ActiveXObject(ti),
    ...
    ei = function() {
        if (!n.w3) return; (typeof t.readyState != i && t.readyState == "complete" || typeof t.readyState == i && (t.getElementsByTagName("body")[0] || t.body)) && v(),
        c || (typeof t.addEventListener != i && t.addEventListener("DOMContentLoaded", v, !1), n.ie && n.win && (t.attachEvent(yt,
        function() {
        ...
        function() {
            for (var e = a.length,
            u, i, r, f, t = 0; t < e; t++) a[t][0].detachEvent(a[t][1], a[t][2]);
